  ...
  <div class="kontainer">
    ...
    <div class="baris">
      ...
      <div class="kolom" style="height:80px;width:350px;float:left;padding:10px;border-bottom: solid;">
        ...
        PPh 21: '.$_SESSION['uraian'].' "'.$_SESSION['judul'].'"'.'<br>
        an. '.$_SESSION['peneliti'].' dkk</div>
      </div>
    </div>
    <div style="clear: both;" />
    <div class="baris">
    ...
    <div class="baris">
      ...
      <div class="kolom" style="height:110px;width:350px;float:left;padding:10px;border-bottom: solid;">
        <b>Wajib Pajak/Penyetor</b><br>Pontianak, <b>tgl</b> '.$_SESSION['tanggal'].'<br><br><br><br><b>Nama Jelas:</b> '.$_SESSION['penyetor'].'
      </div>
    </div>
    <div style="clear: both;" />
    <div class="baris">
...
$dompdf->render();
$dompdf->stream('pph21_'.$_SESSION['masa'].'_'.$_SESSION['tahun'].'.pdf');
?>