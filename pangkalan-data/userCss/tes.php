<?php
$tahun="2014";
$arr_tahun = str_split($tahun);
?>
<!DOCTYPE html>
<head>
<meta charset="utf-8">
<link rel="stylesheet" type="text/css" href="css/styletes.css">
<title></title>
</head>
<body>
  <div class="kontainer">
    <div class="baris">
      <div class="kolom" style="height:70px;width:80px;float:left;padding:10px;border-bottom: solid;">
        <img src="images/logo-depkeu-hitam-putih.png" style="height:1.96cm; width:1.98cm;"/>
      </div>
      <div class="kolom" style="height:70px;width:250px;float:left;padding:10px;border-right: solid;border-bottom: solid;">
        <div class="judul">DEPARTEMEN KEUANGAN R.I<br>DIREKTORAT JENDERAL PAJAK<br>KANTOR PELAYANAN PAJAK<br>PONTIANAK</div>
      </div>
      <div class="kolom" style="height:70px;width:200px;float:left;padding:10px;border-right: solid;border-bottom: solid;">
        <div class="judul2">SURAT SETORAN PAJAK</div><br>
        <div class="judul3">(SSP)</div>
      </div>
      <div class="kolom" style="height:70px;width:200px;float:left;padding:10px;border-bottom: solid;">
        <table>
          <tr>
    ...
    <div style="clear: both;" />
    <div class="baris">
      <div class="kolom" style="height:35px;width:90px;float:left;padding:10px;border-bottom: solid;">
        <div class="judul2">NAMA WP:<br>ALAMAT:</div>
      </div>
      <div class="kolom" style="height:35px;width:580px;float:left;padding:10px;border-bottom: solid;">
        Rutin/Gaji Universitas Tanjungpura<br>Jl. Ahmad Yani Pontianak
      </div>
    </div>
    <div style="clear: both;" />
    <div class="baris">
      <div class="kolom" style="height:90px;width:150px;float:left;padding:10px;border-bottom: solid;">
      ...
      <div class="kolom" style="height:90px;width:130px;float:left;padding:10px;border-bottom: solid;border-right:solid;">
      ...
      <div class="kolom" style="height:90px;width:430px;float:left;padding:10px;border-bottom: solid;">
        <div class="judul6">Uraian Pembayaran<br>
        PPh 21: Honorarium Tim Penelitian "Pengembangan Jaringan Reklamasi Rawa Pasang Surut untuk Mendukung Peningkatan Produktivitas Tanaman Pangan Di Kalimantan Barat"<br>
        an. Abc dkk</div>
      </div>
    </div>
    <div style="clear: both;" />
    <div class="baris">
      ...
      <div class="kolom" style="height:80px;width:300px;float:left;padding:10px;border-bottom: solid;">
        Tahun<br>
        <table cellpadding="3">
          <tr>
            <td style="border: 1px solid black;"><?php echo $arr_tahun[0]; ?></td>
            <td style="border: 1px solid black;"><?php echo $arr_tahun[1]; ?></td>
            <td style="border: 1px solid black;"><?php echo $arr_tahun[2]; ?></td>
            <td style="border: 1px solid black;"><?php echo $arr_tahun[3]; ?></td>
          </tr>
        </table>
    ...
    <div style="clear: both;" />
    <div class="baris">
      <div class="kolom" style="height:5px;width:650px;float:left;padding:10px;border-bottom: solid;">
    ...
    <div class="baris">
      ...
      <div class="kolom" style="height:65px;width:550px;float:left;padding:10px;border-bottom: solid;">
        <div class="judul6">Terbilang: Tiga ratus ribu rupiah</div>
      </div>
    </div>
    <div style="clear: both;" />
    <div class="baris">
      <div class="kolom" style="height:100px;width:310px;float:left;padding:10px;border-bottom: solid;border-right: solid;">
        <b>Diterima oleh Kantor Penerima Pembayaran<br>Tanggal</b><br><div class="judul5">Cap dan tanda tangan</div><br><b>Nama Jelas:</b>
      </div>
      <div class="kolom" style="height:100px;width:300px;float:left;padding:10px;border-bottom: solid;">
        <b>Wajib Pajak/Penyetor</b><br>Pontianak, <b>tgl</b> 2014-12-17<br><br><br><br><b>Nama Jelas:</b> Abc
      </div>
    </div>
    <div style="clear: both;" />
    <div class="baris">
