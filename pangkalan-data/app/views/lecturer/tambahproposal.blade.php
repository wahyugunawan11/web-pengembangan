...
<li class="treeview active">
    ...
    <ul class="treeview-menu">
        ...
        <li class="active"><a href="{{URL::to('/lecturer_addproposal')}}"><i class="fa fa-circle-o"></i> Tambah data</a></li>
    </ul>
</li>
<li class="treeview">
    <a href="#">
...
<ol class="breadcrumb">
    ...
    <li><a href="#">Manajemen proposal</a></li>
...
<div class="col-xs-12">
    ...
    <div class="box box-primary">
        ...
        <!-- form start -->
        {{Form::open(array('method'=>'post', 'url'=>'/ptproposaldosen', 'files'=>'true'))}}
        <div class="box-body">
