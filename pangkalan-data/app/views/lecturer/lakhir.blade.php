...
function hapuslaporanakhir(idlapakhir){
    ...
    if(hasil==true){
        window.location.href="proses_hadosen/"+idlapakhir;
    }
}
</script>
@stop
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="{{URL::to('/lecturer_editfinal/'.$laporanakhir2->idlapakhir)}}">Ubah</a> | <button class="btn btn-danger"><a onclick="hapuslaporanakhir({{$laporanakhir2->idlapakhir}})">Hapus</button> | <a href="{{URL::to('/lecturer_viewfinal/'.$laporanakhir2->idlapakhir)}}" target="_blank">Lihat</a></td>
                    </tr>
                    @endforeach
                </tbody>
                <tfoot>
