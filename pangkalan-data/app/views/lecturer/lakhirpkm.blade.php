...
function hlaporanakhirpkm(idlakhir_pkm){
    var hasil = confirm('Mau hapus?');
    if(hasil==true){
        window.location.href="proses_hapkmdosen/"+idlakhir_pkm;
    }
}
</script>
@stop
        ...
        <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$i++}}</td>
                        <td>{{$laporanakhirpkm2->judul}}</td>
                        <td>{{$laporanakhirpkm2->sumberdana}}</td>
                        <td>{{$laporanakhirpkm2->tahun}}</td>
                        <td>{{$laporanakhirpkm2->read_more}}</td>
                        <td>{{$laporanakhirpkm2->programstudi}}</td>
                        <td>{{$laporanakhirpkm2->skim}}</td>
                        <td>{{$laporanakhirpkm2->bidangilmu}}</td>
                        <td>{{$laporanakhirpkm2->fakultas}}</td>
                        <td>{{$laporanakhirpkm2->ketua}}</td>
                        <td>{{$laporanakhirpkm2->anggota1}}</td>
                        <td>{{$laporanakhirpkm2->anggota2}}</td>
                        <td>{{$laporanakhirpkm2->anggota3}}</td>
                        <td>{{$laporanakhirpkm2->anggota4}}</td>
                        <td>{{$laporanakhirpkm2->anggotalain}}</td>
                        <td><a href="{{URL::to('/lecturer_epkmfinal/'.$laporanakhirpkm2->idlakhir_pkm)}}">Ubah</a> | <button class="btn btn-danger"><a onclick="hlaporanakhirpkm({{$laporanakhirpkm2->idlakhir_pkm}})">Hapus</button> | <a href="{{URL::to('/lecturer_vpkmfinal/'.$laporanakhirpkm2->idlakhir_pkm)}}" target="_blank">Lihat</a></td>
                    </tr>
                    @endforeach
                </tbody>
                <tfoot>
