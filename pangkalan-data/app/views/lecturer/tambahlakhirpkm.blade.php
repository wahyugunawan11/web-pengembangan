...
@section('title')
<title>Laporan Akhir PKM | Dosen | Pangkalan Data Penelitian</title>
@stop
@section('style')
<!-- Other Csses -->
...
<li class="treeview active">
    ...
    <ul class="treeview-menu">
        ...
        <li class="active"><a href="{{URL::to('/lecturer_apkmfinal')}}"><i class="fa fa-circle-o"></i> Tambah data</a></li>
    </ul>
</li>
<li>
...
<div class="col-xs-12">
    ...
    <div class="box box-primary">
        <div class="box-header">
            <h3 class="box-title">Tambah Data Laporan Akhir PKM</h3>
        </div><!-- /.box-header -->
        <!-- form start -->
        {{Form::open(array('method'=>'post', 'url'=>'/ptakhirpkmdosen', 'files'=>'true'))}}
        <div class="box-body">
            <div class="form-group">
                <label>Judul</label>
                <input type="text" class="form-control" placeholder="Judul laporan akhir PKM" name="judul">
            </div>
            <div class="form-group">
                <div class="row">
                    <div class="col-xs-4">
