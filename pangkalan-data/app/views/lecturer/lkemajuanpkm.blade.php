...
function hlaporankemajuanpkm(idlkemajuanpkm){
    var hasil = confirm('Mau hapus?');
    if(hasil==true){
        window.location.href="proses_hkpkmdosen/"+idlkemajuanpkm;
    }
}
</script>
@stop
        ...
        <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$i++}}</td>
                        <td>{{$laporankemajuanpkm2->judul}}</td>
                        <td>{{$laporankemajuanpkm2->sumberdana}}</td>
                        <td>{{$laporankemajuanpkm2->tahun}}</td>
                        <td>{{$laporankemajuanpkm2->read_more}}</td>
                        <td>{{$laporankemajuanpkm2->programstudi}}</td>
                        <td>{{$laporankemajuanpkm2->skim}}</td>
                        <td>{{$laporankemajuanpkm2->bidangilmu}}</td>
                        <td>{{$laporankemajuanpkm2->fakultas}}</td>
                        <td>{{$laporankemajuanpkm2->ketua}}</td>
                        <td>{{$laporankemajuanpkm2->anggota1}}</td>
                        <td>{{$laporankemajuanpkm2->anggota2}}</td>
                        <td>{{$laporankemajuanpkm2->anggota3}}</td>
                        <td>{{$laporankemajuanpkm2->anggota4}}</td>
                        <td>{{$laporankemajuanpkm2->anggotalain}}</td>
                        <td><a href="{{URL::to('/lecturer_epkmprogress/'.$laporankemajuanpkm2->idlkemajuanpkm)}}">Ubah</a> | <button class="btn btn-danger"><a onclick="hlaporankemajuanpkm({{$laporankemajuanpkm2->idlkemajuanpkm}})">Hapus</button> | <a href="{{URL::to('/lecturer_vpkmprogress/'.$laporankemajuanpkm2->idlkemajuanpkm)}}" target="_blank">Lihat</a></td>
                    </tr>
                    @endforeach
                </tbody>
                <tfoot>
