...
<li class="treeview active">
    ...
    <ul class="treeview-menu">
        ...
        <li class="active"><a href="{{URL::to('/lecturer_addprogress')}}"><i class="fa fa-circle-o"></i> Tambah data</a></li>
    </ul>
</li>
<li class="treeview">
    <a href="#">
...
<div class="col-xs-12">
    ...
    <div class="box box-primary">
        ...
        <!-- form start -->
        {{Form::open(array('method'=>'post', 'url'=>'/ptkemajuandosen', 'files'=>'true'))}}
        <div class="box-body">
