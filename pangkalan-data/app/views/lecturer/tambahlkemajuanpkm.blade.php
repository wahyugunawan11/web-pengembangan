...
<li class="treeview active">
    ...
    <ul class="treeview-menu">
        ...
        <li class="active"><a href="{{URL::to('/lecturer_apkmprogress')}}"><i class="fa fa-circle-o"></i> Tambah data</a></li>
    </ul>
</li>
<li class="treeview">
    <a href="#">
...
<div class="col-xs-12">
    ...
    <div class="box box-primary">
        ...
        <!-- form start -->
        {{Form::open(array('method'=>'post', 'url'=>'/ptkemajuanpkmdosen', 'files'=>'true'))}}
        <div class="box-body">
            <div class="form-group">
                <label>Judul</label>
                <input type="text" class="form-control" placeholder="Judul laporan kemajuan PKM" name="judul">
            </div>
            <div class="form-group">
                <div class="row">
                    <div class="col-xs-4">
