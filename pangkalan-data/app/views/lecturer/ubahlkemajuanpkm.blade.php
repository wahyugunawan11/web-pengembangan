...
@section('title')
<title>Laporan Kemajuan PKM | Dosen | Pangkalan Data Penelitian</title>
@stop
...
<div class="col-xs-12">
    ...
    <div class="box box-primary">
        ...
        {{Form::open(array('method'=>'post', 'url'=>'/proses_ukpkmdosen/'.$laporankemajuanpkm2->idlkemajuanpkm, 'files'=>'true'))}}
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <p class="help-block">Pilih file laporan kemajuan PKM (ekstensi *.pdf)</p>
                <?php
