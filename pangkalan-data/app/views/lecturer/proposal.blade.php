...
function hapusproposal(idproposal){
    ...
    if(hasil==true){
        window.location.href="proses_hpdosen/"+idproposal;
    }
}
</script>
@stop
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="{{URL::to('/lecturer_editproposal/'.$proposal2->idproposal)}}">Ubah</a> | <button class="btn btn-danger"><a onclick="hapusproposal({{$proposal2->idproposal}})">Hapus</button> | <a href="{{URL::to('/lecturer_viewproposal/'.$proposal2->idproposal)}}" target="_blank">Lihat</a></td>
                    </tr>
                    @endforeach
                </tbody>
                <tfoot>
