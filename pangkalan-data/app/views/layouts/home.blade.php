...
<link href="erudite-pack/web/css/style.css" rel="stylesheet" type="text/css" media="all" />
<!--slider-->
<link href="erudite-pack/web/css/camera.css" rel="stylesheet" type="text/css" media="all" />
    <script type='text/javascript' src="erudite-pack/web/js/jquery.min.js"></script>
    <script type='text/javascript' src="erudite-pack/web/js/jquery.mobile.customized.min.js"></script>
    <script type='text/javascript' src="erudite-pack/web/js/jquery.easing.1.3.js"></script> 
    <script type='text/javascript' src="erudite-pack/web/js/camera.min.js"></script> 
      <script>
		jQuery(function(){
			...
			jQuery('#camera_wrap_4').camera({
				...
				hover: false,
				opacityOnGrid: false,
				imagePath: '../erudite-pack/web/images/'
			});
