...
@section('judul')
<title>Pangkalan Data Penelitian | Data Dosen</title>
@stop
...
<div class="content">
  ...
  <!-- form start -->
  {{Form::open(array('method'=>'post', 'url'=>'/searchlecturer'))}}
  <div class="form_settings">
    ...
    <p><span>Kata kunci:</span><input class="contact" type="text" name="kunci" value="" placeholder="Nama/Tempat lahir" /></p>
