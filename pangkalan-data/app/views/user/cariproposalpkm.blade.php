...
<div class="content">
  ...
  <table class="table table-striped table-bordered table-hover" id="dataTablesexample">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a href="{{URL::to('/viewpkmproposal/'.$result->idproposalpkm)}}" target="_blank">Lihat</a></td>
      </tr>
      @endforeach
    </tbody>
  </table>
  ...
  <div class="col span_2_of_4">
    <a href="{{URL::to('/pkmproposal')}}" class="btn btn-link">Kembali ke pencarian</a>
  </div>
</div>
@stop
