...
<div class="content">
  ...
  <h1>Lihat Data Laporan Akhir PKM</h1>
  <h4>Judul:</h4>
  <p>{{$laporanakhirpkm2->judul}}</p>
  <h4>Sumber dana:</h4>
  <p>{{$laporanakhirpkm2->sumberdana}}</p>
  <h4>Tahun:</h4>
  <p>{{$laporanakhirpkm2->tahun}}</p>
  <h4>Abstrak:</h4>
  <p>{{$laporanakhirpkm2->abstrak}}</p>
  <h4>Program studi:</h4>
  <p>{{$laporanakhirpkm2->programstudi}}</p>
  <h4>Skim penelitian:</h4>
  <p>{{$laporanakhirpkm2->skim}}</p>
  <h4>Bidang ilmu:</h4>
  <p>{{$laporanakhirpkm2->bidangilmu}}</p>
  <h4>Fakultas:</h4>
  <p>{{$laporanakhirpkm2->fakultas}}</p>
  <h4>Ketua:</h4>
  <p>{{$laporanakhirpkm2->ketua}}</p>
  <h4>Anggota:</h4>
  <p>
    ...
    @elseif(($laporanakhirpkm2->namafileakhir != '') and ($laporanakhirpkm2->statusfile == '1'))
