...
@section('title')
<title>Proposal PKM | KaLemlit | Pangkalan Data Penelitian</title>
@stop
...
<ol class="breadcrumb">
    ...
    <li class="active">Data proposal PKM</li>
</ol>
@stop
@section('inner')
<div class="row">
                ...
                <dl class="dl-horizontal">
                    ...
                    @else
                      <div class="col span_2_of_4">
                        <a class="btn btn-success" href="{{URL::to('/downloadpkmproposal/'.$proposalpkm2->idproposalpkm)}}">Download Proposal PKM</a>
                      </div>
                    @endif
                </dl>
                @endforeach
