...
@section('title')
<title>Laporan Kemajuan | KaLemlit | Pangkalan Data Penelitian</title>
@stop
@section('style')
<!-- Bootstrap 3.3.4 -->
			...
			<table id="example1" class="table table-bordered table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td><a href="{{URL::to('/chief_viewprogress/'.$laporankemajuan2->idlapkemajuan)}}" target="_blank">Lihat</a></td>
					</tr>
					@endforeach
				</tbody>
				<tfoot>
