...
<div class="col-xs-12">
    ...
    <div class="box box-primary">
        ...
        <!-- form start -->
        {{Form::open(array('url'=>'admin_addprogress/', 'method'=>'POST'))}}
        <div class="box-body">
        	<div class="form-group">
                <label>Cari judul</label>
                <input type="text" class="form-control" placeholder="Judul proposal" name="auto" id="auto">
            </div>
        </div><!-- /.box-body -->
