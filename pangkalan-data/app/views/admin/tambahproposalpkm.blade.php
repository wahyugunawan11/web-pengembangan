...
<div class="col-xs-12">
    ...
    <div class="box box-primary">
        <div class="box-header">
            <h3 class="box-title">Tambah Data Proposal PKM</h3>
        </div><!-- /.box-header -->
        <!-- form start -->
        {{Form::open(array('method'=>'post', 'url'=>'/proses_tproposalpkm', 'files'=>'true'))}}
        <div class="box-body">
        	<div class="form-group">
                <label>Judul</label>
                <input type="text" class="form-control" placeholder="Judul proposal" name="judul">
            </div>
        	<div class="form-group">
        		<div class="row">
        			<div class="col-xs-4">
