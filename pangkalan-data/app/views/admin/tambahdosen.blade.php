...
<li class="treeview active">
	...
	<ul class="treeview-menu">
        ...
        <li class="active"><a href="{{URL::to('/admin_addlecturer')}}"><i class="fa fa-circle-o"></i> Tambah data</a></li>
    </ul>
</li>
<li class="treeview">
    <a href="#">
...
<div class="col-xs-12">
    ...
    <div class="box box-primary">
        ...
        <!-- form start -->
        {{Form::open(array('method'=>'post', 'url'=>'/proses_tambahdosen', 'files'=>'true'))}}
        <div class="box-body">
        	<div class="form-group">
        		<div class="row">
        			<div class="col-xs-4">
        				<label>NIDN</label>
        				<input type="text" class="form-control" placeholder="Nomor Induk Dosen Nasional" name="nidn">
        			</div>
        		</div>
        	</div>
        	<div class="form-group">
        	...
        	<div class="form-group">
        		<div class="row">
        			<div class="col-xs-5">
        				...
        				<input type="text" class="form-control" placeholder="Username dosen" name="username">
        			</div>
        		</div>
        	</div>
        	<div class="form-group">
        		<div class="row">
        			<div class="col-xs-5">
        				...
        				<input type="text" class="form-control" placeholder="Password dosen" name="password">
        			</div>
        		</div>
        	</div>
        	<div class="form-group">
        		<div class="row">
        			<div class="col-xs-3">
        				<label>Pangkat</label>
        				<input type="text" class="form-control" placeholder="Pangkat dosen" name="pangkat">
        			</div>
        			<div class="col-xs-3">
        				<label>Golongan</label>
        				<input type="text" class="form-control" placeholder="Golongan dosen" name="golongan">
        			</div>
        		</div>
        	</div>
        	<div class="form-group">
        		<div class="row">
        			<div class="col-xs-5">
        				<label>E-mail</label>
        				<input type="text" class="form-control" placeholder="E-mail dosen" name="email">
        			</div>
        		</div>
        	</div>
        	<div class="form-group">
        		...
        		<div class="input-group">
        			...
        			<input type="text" class="form-control" name="notelp" data-inputmask="'mask': ['099999999999']" data-mask/>
        		</div>
        	</div>
        	<div class="form-group">
        	...
        	<div class="form-group">
        		<div class="row">
        			<div class="col-xs-5">
        				...
        				<input type="text" class="form-control" placeholder="Tempat lahir dosen" name="tempatlahir">
        			</div>
        		</div>
        	</div>
        	<div class="form-group">
        		...
        		<div class="input-group">
        			...
        			<input type="text" class="form-control" name="tanggallahir" data-inputmask="'alias': 'yyyy-mm-dd'" data-mask/>
        		</div>
        	</div>
        	<div class="form-group">
        	...
        	<div class="form-group">
        		...
        		<div class="row">
        			<div class="col-lg-6">
        				<div class="input-group">
        					<span class="input-group-addon">
        						<input type="radio" name="jabatanfungsional" value="GB" checked>
        					</span>
        					Guru Besar
        				</div>
        			</div>
        		...
        		<div class="row">
        			<div class="col-lg-6">
        				<div class="input-group">
        					<span class="input-group-addon">
        						<input type="radio" name="jabatanfungsional" value="LK">
        					</span>
        					Lektor Kepala
        				</div>
        			</div>
        		...
        		<div class="row">
        			<div class="col-lg-6">
        				<div class="input-group">
        					<span class="input-group-addon">
        						<input type="radio" name="jabatanfungsional" value="L">
        					</span>
        					Lektor
        				</div>
        			</div>
        		...
        		<div class="row">
        			<div class="col-lg-6">
        				<div class="input-group">
        					<span class="input-group-addon">
        						<input type="radio" name="jabatanfungsional" value="AA">
        					</span>
        					Asisten Ahli
        				</div>
        			</div>
        		...
        		<div class="row">
        			<div class="col-lg-6">
        				<div class="input-group">
        					<span class="input-group-addon">
        						<input type="radio" name="jabatanfungsional" value="TP">
        					</span>
        					Tenaga Pengajar
        				</div>
        			</div>
