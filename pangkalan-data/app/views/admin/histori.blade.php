...
@section('title')
<title>Histori | Administrator | Pangkalan Data Penelitian</title>
@stop
@section('style')
<!-- Bootstrap 3.3.4 -->
...
<ol class="breadcrumb">
	...
	<li class="active">Lihat histori</li>
</ol>
@stop
	...
	<div class="box">
		...
		<div class="box-body">
			<table id="example1" class="table table-bordered table-striped">
				...
				<tbody>
					@foreach ($history as $index => $history2)
					<tr>
						<td>{{$history2->keterangan}}</td>
						<td>{{$history2->tanggalwaktu}}</td>
						<td>{{$history2->username}}</td>
					</tr>
					@endforeach
				</tbody>
				<tfoot>
