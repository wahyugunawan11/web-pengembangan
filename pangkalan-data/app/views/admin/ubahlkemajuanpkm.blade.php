...
@section('title')
<title>Laporan Kemajuan PKM | Administrator | Pangkalan Data Penelitian</title>
@stop
...
<li class="treeview active">
    ...
    <ul class="treeview-menu">
        ...
        <li class="active">
            <a href="#"><i class="fa fa-circle-o"></i> Laporan kemajuan <i class="fa fa-angle-left pull-right"></i></a>
            <ul class="treeview-menu">
                <li class="active"><a href="{{URL::to('/adminpkmprogress')}}"><i class="fa fa-circle-o"></i> Lihat data</a></li>
...
<div class="col-xs-12">
    ...
    <div class="box box-primary">
        <div class="box-header">
            <h3 class="box-title">Ubah Data Laporan Kemajuan PKM</h3>
        </div><!-- /.box-header -->
        <!-- form start -->
        @foreach ($laporankemajuanpkm as $index => $laporankemajuanpkm2)
        {{Form::open(array('method'=>'post', 'url'=>'/proses_ukemajuanpkm/'.$laporankemajuanpkm2->idlkemajuanpkm, 'files'=>'true'))}}
        <div class="box-body">
        	<div class="form-group">
                <label>Judul</label>
                <input type="text" class="form-control" name="judul" value='{{$laporankemajuanpkm2->judul}}'>
        	</div>
            <div class="form-group">
                <div class="row">
                    <div class="col-xs-4">
                        <label>Sumber Dana</label>
                        <input type="text" class="form-control" name="sumberdana" value='{{$laporankemajuanpkm2->sumberdana}}'>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <select class="form-control" name="tahun">
                    <option value="{{$laporankemajuanpkm2->tahun}}">{{$laporankemajuanpkm2->tahun}}</option>
                    <?php 
                    for ($i=1970;$i<=2100;$i++){
                        $tahun=$i;
                         ?>
            ...
            <div class="form-group">
                ...
                <p class="help-block">Pilih file proposal (ekstensi *.pdf)</p>
                <?php
                    if($laporankemajuanpkm2->namafilekemajuan != "")
                        echo '<p class="help-block" style="color:green"><b>Laporan kemajuan PKM sudah pernah di-upload.</b></p>';
                    else
                        echo '<p class="help-block" style="color:red"><b>Laporan kemajuan PKM belum di-upload!</b></p>';
                ?>
            </div>
            <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <div class="input-group">
                            <span class="input-group-addon">
                                <input type="radio" name="statusfile" value="1" <?php if($laporankemajuanpkm2->statusfile == "1") echo 'checked="checked"'; ?>>
                            </span>
                            Open
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="input-group">
                            <span class="input-group-addon">
                                <input type="radio" name="statusfile" value="2" <?php if($laporankemajuanpkm2->statusfile == "2") echo 'checked="checked"'; ?>>
                            </span>
                            Protected
                        </div>
                    </div>
            ...
            <div class="form-group">
                <label>Abstrak</label>
                <textarea class="form-control" rows="3" placeholder="Abstrak" name="abstrak">{{$laporankemajuanpkm2->abstrak}}</textarea>
            </div>
            <div class="form-group">
                <label>Program Studi</label>
                <select class="form-control" name="idprodi">
                    <option value="{{$laporankemajuanpkm2->kemajuanidprodi}}">{{$laporankemajuanpkm2->programstudi}}</option>
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="idskimpenelitian">
                    <option value="{{$laporankemajuanpkm2->kidskimpenelitian}}">{{$laporankemajuanpkm2->skim}}</option>
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="idbidilmu">
                    <option value="{{$laporankemajuanpkm2->kemajuanidbidilmu}}">{{$laporankemajuanpkm2->bidangilmu}}</option>
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="idfakultas">
                    <option value="{{$laporankemajuanpkm2->kemajuanidfakultas}}">{{$laporankemajuanpkm2->fakultas}}</option>
            ...
            <div class="form-group">
                <label>Ketua</label>
                <input type="text" class="form-control" name="idketua" value="{{$laporankemajuanpkm2->ketua}}" id="wcust" onKeyUp='vcust(this.value)' />
                ...
                <input type="text" class="form-control" name="idketua2" value="{{$laporankemajuanpkm2->kemajuanidketua}}" id='idketua2'>
            </div>
            <div class="form-group">
                <label>Anggota 1</label>
                <input type="text" class="form-control" name="anggota1" value="{{$laporankemajuanpkm2->anggota1}}" id="anggota1" onKeyUp='anggota1ku(this.value)' />
                ...
                <input type="text" class="form-control" name="idanggota1" value="{{$laporankemajuanpkm2->kidanggota1}}" id='idanggota1'>
            </div>
            <div class="form-group">
                <label>Anggota 2</label>
                <input type="text" class="form-control" name="anggota2" value="{{$laporankemajuanpkm2->anggota2}}" id="anggota2" onKeyUp='anggota2ku(this.value)' />
                ...
                <input type="text" class="form-control" name="idanggota2" value="{{$laporankemajuanpkm2->kidanggota2}}" id='idanggota2'>
            </div>
            <div class="form-group">
                <label>Anggota 3</label>
                <input type="text" class="form-control" name="anggota3" value="{{$laporankemajuanpkm2->anggota3}}" id="anggota3" onKeyUp='anggota3ku(this.value)' />
                ...
                <input type="text" class="form-control" name="idanggota3" value="{{$laporankemajuanpkm2->kidanggota3}}" id='idanggota3'>
            </div>
            <div class="form-group">
                <label>Anggota 4</label>
                <input type="text" class="form-control" name="anggota4" value="{{$laporankemajuanpkm2->anggota4}}" id="anggota4" onKeyUp='anggota4ku(this.value)' />
                ...
                <input type="text" class="form-control" name="idanggota4" value="{{$laporankemajuanpkm2->kidanggota4}}" id='idanggota4'>
            </div>
            <div class="form-group">
                <label>Anggota Lain</label>
                <input type="text" class="form-control" name="anggotalain" value="{{$laporankemajuanpkm2->anggotalain}}">
            </div>
        </div><!-- /.box-body -->
