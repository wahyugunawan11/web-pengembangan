    ...
    <ul class="treeview-menu">
        ...
        <li class="active">
            ...
            <ul class="treeview-menu">
                ...
                <li class="active"><a href="{{URL::to('/admin_apkmprogress')}}"><i class="fa fa-circle-o"></i> Tambah data</a></li>
            </ul>
        </li>
        <li>
            <a href="#"><i class="fa fa-circle-o"></i> Laporan akhir <i class="fa fa-angle-left pull-right"></i></a>
...
<div class="col-xs-12">
    ...
    <div class="box box-primary">
        <div class="box-header">
            <h3 class="box-title">Tambah Data Laporan Kemajuan PKM</h3>
        </div><!-- /.box-header -->
        <!-- form start -->
        {{Form::open(array('method'=>'post', 'url'=>'/proses_tkemajuanpkm', 'files'=>'true'))}}
        <div class="box-body">
            <div class="form-group">
                <label>Judul</label>
                <input type="text" class="form-control" placeholder="Judul laporan kemajuan" name="judul">
            </div>
            <div class="form-group">
                <div class="row">
                    <div class="col-xs-4">
                        <label>Sumber Dana</label>
                        <input type="text" class="form-control" placeholder="Sumber dana" name="sumberdana">
                    </div>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label>Abstrak</label>
                <textarea class="form-control" rows="3" placeholder="Abstrak" name="abstrak"></textarea>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label>Ketua</label>
                <input type="text" class="form-control" name="idketua" value="" id="wcust" onKeyUp='vcust(this.value)' />
                ...
                <input type="text" class="form-control" name="idketua2" value="" id='idketua2'>
            </div>
            <div class="form-group">
                <label>Anggota 1</label>
                <input type="text" class="form-control" name="anggota1" value="" id="anggota1" onKeyUp='anggota1ku(this.value)' />
                ...
                <input type="text" class="form-control" name="idanggota1" value="" id='idanggota1'>
            </div>
            <div class="form-group">
                <label>Anggota 2</label>
                <input type="text" class="form-control" name="anggota2" value="" id="anggota2" onKeyUp='anggota2ku(this.value)' />
                ...
                <input type="text" class="form-control" name="idanggota2" value="" id='idanggota2'>
            </div>
            <div class="form-group">
                <label>Anggota 3</label>
                <input type="text" class="form-control" name="anggota3" value="" id="anggota3" onKeyUp='anggota3ku(this.value)' />
                ...
                <input type="text" class="form-control" name="idanggota3" value="" id='idanggota3'>
            </div>
            <div class="form-group">
                <label>Anggota 4</label>
                <input type="text" class="form-control" name="anggota4" value="" id="anggota4" onKeyUp='anggota4ku(this.value)' />
                ...
                <input type="text" class="form-control" name="idanggota4" value="" id='idanggota4'>
            </div>
            <div class="form-group">
                <label>Anggota Lain</label>
                <input type="text" class="form-control" placeholder="Anggota 1/Anggota 2/Anggota ke-n" name="anggotalain">
            </div>
        </div><!-- /.box-body -->
