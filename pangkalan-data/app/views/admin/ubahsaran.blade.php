...
@section('title')
<title>Pesan/Saran | Administrator | Pangkalan Data Penelitian</title>
@stop
...
<ol class="breadcrumb">
	...
	<li class="active">Manajemen pesan/saran</li>
</ol>
@stop
...
<div class="col-xs-12">
    ...
    <div class="box box-primary">
        <div class="box-header">
            <h3 class="box-title">Ubah Data Saran</h3>
        </div><!-- /.box-header -->
        <!-- form start -->
        {{Form::open(array('method'=>'post', 'url'=>'/proses_ubahsaran/'.$saran->id_saran))}}
        <div class="box-body">
        	<div class="form-group">
        		<div class="col-xs-4">
        			<label>Nama</label>
        			<input type="text" class="form-control" name="nama" value='{{$saran->nama}}'>
        		</div>
        	</div>
            <div class="form-group">
                <div class="row">
                    <div class="col-xs-4">
                        <label>E-mail</label>
                        <input type="text" class="form-control" name="email" value='{{$saran->email}}'>
                    </div>
                </div>
            </div>
            <div class="form-group">
                <label>Saran</label>
                <textarea class="form-control" rows="3" name="msg">{{$saran->saran}}</textarea>
            </div>
        </div><!-- /.box-body -->
