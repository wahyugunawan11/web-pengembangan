    ...
    <ul class="treeview-menu">
        ...
        <li class="active">
            ...
            <ul class="treeview-menu">
                ...
                <li class="active"><a href="{{URL::to('/admin_apkmfinal')}}"><i class="fa fa-circle-o"></i> Tambah data</a></li>
            </ul>
        </li>
    </ul>
</li>
...
<div class="col-xs-12">
    ...
    <div class="box box-primary">
        ...
        <!-- form start -->
        {{Form::open(array('method'=>'post', 'url'=>'/proses_takhirpkm', 'files'=>'true'))}}
        <div class="box-body">
        	<div class="form-group">
                <label>Judul</label>
                <input type="text" class="form-control" placeholder="Judul laporan akhir" name="judul">
            </div>
        	<div class="form-group">
        		<div class="row">
        			<div class="col-xs-4">
