...
function hapuslakhirpkm(idlakhir_pkm){
	var hasil = confirm('Mau hapus?');
	if(hasil==true){
		window.location.href="proses_hakhirpkm/"+idlakhir_pkm;
	}
}
</script>
@stop
			...
			<table id="example1" class="table table-bordered table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td><a href="{{URL::to('/admin_epkmfinal/'.$laporanakhirpkm2->idlakhir_pkm)}}">Ubah</a> | <button class="btn btn-danger"><a onclick="hapuslakhirpkm({{$laporanakhirpkm2->idlakhir_pkm}})">Hapus</button></td>
					</tr>
					@endforeach
				</tbody>
				<tfoot>
