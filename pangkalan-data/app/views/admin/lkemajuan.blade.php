...
function hapuslaporankemajuan(idlapkemajuan){
	...
	if(hasil==true){
		window.location.href="proses_hapuskemajuan/"+idlapkemajuan;
	}
}
</script>
<script>
...
<li class="treeview active">
	...
	<ul class="treeview-menu">
		...
		<li class="active">
			...
			<ul class="treeview-menu">
				<li class="active"><a href="{{URL::to('/adminprogress')}}"><i class="fa fa-circle-o"></i> Lihat data</a></li>
			...
			<table id="example1" class="table table-bordered table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td><a href="{{URL::to('/admin_editprogress/'.$laporankemajuan2->idlapkemajuan)}}">Ubah</a> | <button class="btn btn-danger"><a onclick="hapuslaporankemajuan({{$laporankemajuan2->idlapkemajuan}})">Hapus</button></td>
					</tr>
					@endforeach
				</tbody>
				<tfoot>
