...
function hapusproposalpkm(idproposalpkm){
	...
	if(hasil==true){
		window.location.href="proses_hproposalpkm/"+idproposalpkm;
	}
}
</script>
@stop
...
<li class="treeview active">
	...
	<ul class="treeview-menu">
		<li class="active">
			<a href="#"><i class="fa fa-circle-o"></i> Proposal <i class="fa fa-angle-left pull-right"></i></a>
			<ul class="treeview-menu">
				<li class="active"><a href="{{URL::to('/adminpkmproposal')}}"><i class="fa fa-circle-o"></i> Lihat data</a></li>
			...
			<table id="example1" class="table table-bordered table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td><a href="{{URL::to('/admin_epkmproposal/'.$proposalpkm2->idproposalpkm)}}">Ubah</a> | <button class="btn btn-danger"><a onclick="hapusproposalpkm({{$proposalpkm2->idproposalpkm}})">Hapus</button></td>
					</tr>
					@endforeach
				</tbody>
				<tfoot>
