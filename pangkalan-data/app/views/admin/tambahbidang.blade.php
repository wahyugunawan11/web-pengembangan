...
<div class="col-xs-12">
    ...
    <div class="box box-primary">
        <div class="box-header">
            <h3 class="box-title">Tambah Data Bidang Ilmu</h3>
        </div><!-- /.box-header -->
        <!-- form start -->
        {{Form::open(array('method'=>'post', 'url'=>'/proses_tambahbidilmu'))}}
        <div class="box-body">
        	<div class="form-group">
        		<div class="col-xs-5">
        			<label>Bidang ilmu</label>
        			<input type="text" class="form-control" placeholder="Bidang ilmu" name="bidangilmu">
        		</div>
        	</div>
        </div><!-- /.box-body -->
