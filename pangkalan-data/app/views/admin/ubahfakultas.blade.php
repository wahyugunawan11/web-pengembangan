...
<div class="col-xs-12">
    ...
    <div class="box box-primary">
        <div class="box-header">
            <h3 class="box-title">Ubah Data Fakultas</h3>
        </div><!-- /.box-header -->
        <!-- form start -->
        {{Form::open(array('method'=>'post', 'url'=>'/proses_ubahfakultas/'.$fakultas->idfakultas))}}
        <div class="box-body">
        	<div class="form-group">
        		<div class="row">
        			<div class="col-xs-4">
        				<label>Kode</label>
        				<input type="text" class="form-control" name="kode" value='{{$fakultas->kode}}'>
        			</div>
        		</div>
        	</div>
        	<div class="form-group">
