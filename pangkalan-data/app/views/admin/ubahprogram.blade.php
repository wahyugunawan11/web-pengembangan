...
<div class="col-xs-12">
    ...
    <div class="box box-primary">
        <div class="box-header">
            <h3 class="box-title">Ubah Data Program Studi</h3>
        </div><!-- /.box-header -->
        <!-- form start -->
        {{Form::open(array('method'=>'post', 'url'=>'/proses_ubahprogram/'.$programstudi->idprodi))}}
        <div class="box-body">
        	<div class="form-group">
        		<div class="row">
        			<div class="col-xs-4">
        				<label>Program Studi</label>
        				<input type="text" class="form-control" name="programstudi" value='{{$programstudi->programstudi}}'>
        			</div>
        		</div>
        	</div>
        	<div class="form-group">
        		...
        		<select class="form-control" name="idfakultas">
        			<option value="{{$programstudi->idfakultas}}">{{$programstudi->fakultas}}</option>
