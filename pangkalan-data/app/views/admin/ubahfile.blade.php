...
<div class="col-xs-12">
    ...
    <div class="box box-primary">
        <div class="box-header">
            <h3 class="box-title">Ubah Data File</h3>
        </div><!-- /.box-header -->
        <!-- form start -->
        {{Form::open(array('method'=>'post', 'url'=>'/proses_ubahfile/'.$berkas->id_berkas, 'files'=>'true'))}}
        <div class="box-body">
        	<div class="form-group">
                <label>Nama/Keterangan Berkas</label>
                <input type="text" class="form-control" placeholder="Nama/keterangan file" name="nama" value='{{$berkas->keterangan}}'>
            </div>
            <div class="form-group">
                <label for="exampleInputFile">File</label>
                <input type="file" id="exampleInputFile" name="namafile" value='{{$berkas->namafile}}'>
