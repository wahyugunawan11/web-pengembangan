    ...
    <ul class="treeview-menu">
        ...
        <li class="active">
            ...
            <ul class="treeview-menu">
                ...
                <li class="active"><a href="{{URL::to('/admin_addfinal')}}"><i class="fa fa-circle-o"></i> Tambah data</a></li>
            </ul>
        </li>
    </ul>
</li>
...
<div class="col-xs-12">
    ...
    <div class="box box-primary">
        <div class="box-header">
            <h3 class="box-title">Tambah Data Laporan Akhir</h3>
        </div><!-- /.box-header -->
        <!-- form start -->
        {{Form::open(array('method'=>'post', 'url'=>'/proses_tambahakhir', 'files'=>'true'))}}
        <div class="box-body">
