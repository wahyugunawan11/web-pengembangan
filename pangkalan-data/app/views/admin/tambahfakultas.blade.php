...
<li class="treeview active">
	...
	<ul class="treeview-menu">
        ...
        <li class="active"><a href="{{URL::to('/admin_addfaculty')}}"><i class="fa fa-circle-o"></i> Tambah data</a></li>
    </ul>
</li>
<li class="treeview">
	<a href="#">
...
<div class="col-xs-12">
    ...
    <div class="box box-primary">
        <div class="box-header">
            <h3 class="box-title">Tambah Data Fakultas</h3>
        </div><!-- /.box-header -->
        <!-- form start -->
        {{Form::open(array('method'=>'post', 'url'=>'/proses_tambahfakultas'))}}
        <div class="box-body">
        	<div class="form-group">
        		<div class="row">
        			<div class="col-xs-4">
        				<label>Kode</label>
        				<input type="text" class="form-control" placeholder="Kode fakultas" name="kode">
        			</div>
        		</div>
        	</div>
        	<div class="form-group">
