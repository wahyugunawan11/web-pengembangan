...
@section('title')
<title>Bidang Ilmu | Administrator | Pangkalan Data Penelitian</title>
@stop
@section('style')
<!-- Bootstrap 3.3.4 -->
...
<li class="treeview active">
    ...
    <ul class="treeview-menu">
        ...
        <li class="active"><a href="{{URL::to('/admin_addfield')}}"><i class="fa fa-circle-o"></i> Tambah data</a></li>
    </ul>
</li>
<li class="treeview">
	<a href="#">
...
<ol class="breadcrumb">
    ...
    <li><a href="#">Manajemen bidang ilmu</a></li>
...
<div class="col-xs-12">
    ...
    <div class="box box-primary">
        <div class="box-header">
            <h3 class="box-title">Ubah Data Bidang Ilmu</h3>
        </div><!-- /.box-header -->
        <!-- form start -->
        {{Form::open(array('method'=>'post', 'url'=>'/proses_ubahbidilmu/'.$bidangilmu->idbidilmu))}}
        <div class="box-body">
        	<div class="form-group">
        		<div class="col-xs-5">
        			<label>Bidang ilmu</label>
        			<input type="text" class="form-control" name="bidangilmu" value='{{$bidangilmu->bidangilmu}}'>
        		</div>
        	</div>
        </div><!-- /.box-body -->
