...
function hapuslkemajuanpkm(idlkemajuanpkm){
	var hasil = confirm('Mau hapus?');
	if(hasil==true){
		window.location.href="proses_hkemajuanpkm/"+idlkemajuanpkm;
	}
}
</script>
<script>
			...
			<table id="example1" class="table table-bordered table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td><a href="{{URL::to('/admin_epkmprogress/'.$laporankemajuanpkm2->idlkemajuanpkm)}}">Ubah</a> | <button class="btn btn-danger"><a onclick="hapuslkemajuanpkm({{$laporankemajuanpkm2->idlkemajuanpkm}})">Hapus</button></td>
					</tr>
					@endforeach
				</tbody>
				<tfoot>
