...
<li class="treeview active">
    ...
    <ul class="treeview-menu">
        ...
        <li class="active"><a href="{{URL::to('/admin_addskim')}}"><i class="fa fa-circle-o"></i> Tambah data</a></li>
    </ul>
</li>
<li class="">
...
<div class="col-xs-12">
    ...
    <div class="box box-primary">
        <div class="box-header">
            <h3 class="box-title">Tambah Data Skim Penelitian</h3>
        </div><!-- /.box-header -->
        <!-- form start -->
        {{Form::open(array('method'=>'post', 'url'=>'/proses_tambahskim'))}}
        <div class="box-body">
        	<div class="form-group">
                <div class="col-xs-5">
        			<label>Skim</label>
        			<input type="text" class="form-control" placeholder="Skim penelitian" name="skim">
        		</div>
        	</div>
        </div><!-- /.box-body -->
