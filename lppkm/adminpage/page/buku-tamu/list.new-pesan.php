<?php
	...
	$where2="";
	if($sWhere!=''){
		$where2="AND tk.jenis = 'BT' AND tk.baca='N'";
	}else{
		$where2="WHERE tk.jenis = 'BT' AND tk.baca='N'";
	}
	/*
	 * SQL queries
	 * Get data to display
	...
	$sQuery2 = "
		SELECT COUNT(tk.id) as total FROM tb_komentar tk WHERE tk.jenis = 'BT' AND tk.publish='N' AND tk.baca='N'
	";
	$db->runQuery($sQuery2);
